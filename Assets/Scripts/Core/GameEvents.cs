...
public static class GameEvents
{
    ...
    public static Action<bool> OnSlotsFillableEvent;
    ...
    public static Action<PowerUpType, bool> OnPowerUpSuccessEvent; // power up executed successfully
    public static Action<bool> OnPowerUpEnableEvent; // power up executed successfully
